...
from cropgym.envs.pcse_env import AgroManagementContainer, get_weather_data_provider
from cropgym import _CONFIG_PATH
...
def input_nue(n_input, year=None, start=None, end=None, no3_depo=None, nh4_depo=None, crop_name=None):
    if crop_name in "winterwheat":
        n_seed=3.5
    elif crop_name in "potato":
        n_seed=10.6
    else:
        n_seed=0.0
