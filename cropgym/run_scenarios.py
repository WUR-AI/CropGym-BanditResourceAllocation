...
from cropgym.fit_nue_response import make_df_nue_response, solve_discrete_lp_for_env, solve_discrete_lp_online_for_env
...
from cropgym import _SCENARIO_PATH, _DEFAULT_RESULTSDIR
...
def run_region_year(
    ...
    for i in tqdm(farmer_indices, desc=desc):
        ...
        for sy in season_years:
            ...
            env.run_until_past_season_year(
                season_year=int(sy),
                env_agent=runner,
            )
